...
game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Pear Cat Hub",
	Text = "Loading Ui....",
	Icon = "rbxassetid://17739643893"
})

function GetUi() 
    if getgenv().Tvk then
    if game.CoreGui:FindFirstChild("Pear Cat Hub GUI") then
        for a, v in ipairs(game.CoreGui:GetChildren()) do
            if v.Name == "Pear Cat Hub GUI" then
                v:Destroy()
            end
        end
    end
...
local oldcolor = {
    ...
    ["Logo Image"] = "rbxassetid://17739643893",
...
u.NotiGui.Name = "Pear Cat Hub Notification"
...
function t.CreateNoti(H)
    ...
    local g = V .. "," .. W .. "," .. X
    Q.Text = '<font color="rgb(' .. g .. ')">Pear Cat Hub</font> ' .. getgenv().TitleNameNoti
    table.insert(
        c["Title Text Color"],
        function()
            local V = tostring(u.Getcolor(getgenv().UIColor["Title Text Color"])[1])
...
function t.CreateMain(H)
    local Z = tostring(H.Title) or "Pear Cat Hub"
    ...
    ImageButton.Image = "rbxassetid://17739643893"
    ...
    function u.ReloadMain(v)
        ...
        local X = tostring(u.Getcolor(getgenv().UIColor["Title Text Color"])[3])
        local g = V .. "," .. W .. "," .. X
        ad.Text = '<font color="rgb(' .. g .. ')">Pear Cat Hub</font> ' .. getgenv().MainDesc
        table.insert(
            c["Title Text Color"],
            function()
                aa.ImageColor3 = getgenv().UIColor["Title Text Color"]
...
local Main = Library.CreateMain({Title = 'Your Mom Fat | Blox Fruit', Desc = ''})
...
local Page1 = Main.CreatePage({Page_Name = 'Gerenal', Page_Title = 'Function Gerenal'})
local Page2 = Main.CreatePage({Page_Name = 'Item & Quest ', Page_Title = 'Function Item & Quest'})
local Page3 = Main.CreatePage({Page_Name = 'Status-Server ', Page_Title = 'Function Status/Server'})
local Page4 = Main.CreatePage({Page_Name = 'Pvp-Visual', Page_Title = 'Function Pvp-Visual'})
local Page5 = Main.CreatePage({Page_Name = 'Devil Fruit', Page_Title = 'Function Devil Fruit'})
local Page6 = Main.CreatePage({Page_Name = 'Raid-Material', Page_Title = 'Function Raid-Material'})
local Page7 = Main.CreatePage({Page_Name = 'Local Player', Page_Title = 'Function Local Player'})
local Page8 = Main.CreatePage({Page_Name = 'Travel', Page_Title = 'Function Travel'})
local Page9 = Main.CreatePage({Page_Name = 'Shop', Page_Title = 'Function Shop'})
local Page10 = Main.CreatePage({Page_Name = 'RaceV4-Mirage', Page_Title = 'Function RaceV4-Mirage'})
local Page11 = Main.CreatePage({Page_Name = 'Sea Event', Page_Title = 'Function Sea Event'})
local Page12 = Main.CreatePage({Page_Name = 'Misc-Setting', Page_Title = 'Function Misc-Setting'})
local Page13 = Main.CreatePage({Page_Name = 'One Click', Page_Title = 'Function One Click'})

local Section1 = Page1.CreateSection('Config Farming')

local listfastattack = {"0.25", "0.2", "0.15", "0.1", "0.05", "0.02", "0.015", "0.01", "0"}
Section1.CreateDropdown({Title = 'Select Delay Fast Attack', List = listfastattack, Search = false, Selected = false}, function(value)
    _G.m1m_Mode = (Value)
end)
...
Section1.CreateDropdown({Title = 'Select M1 Click', List = listm1click, Search = false, Selected = false}, function(value)
    ChooseWeapon = (Value)
end)
task.spawn(function()
    while wait() do
...
Section1.CreateButton({Title = 'Redeem All Codes'}, function()
...
local Section2 = Page1.CreateSection('Main Farming')

local locallv = Section2.CreateLabel({Title = "Level :"})
spawn(function()
  while wait() do
      pcall(function()
...
Section2.CreateToggle({Title = "Auto Farm Level", Desc = 'Auto Teleport To NPC GetQuest and going to Mob need farm to kill', Default = _G.AutoLevel}, function(value)
    _G.AutoLevel = (value)
end)
...
spawn(function()
    ...
    Section2.CreateToggle({Title = "Farm Near (Mob Aura)", Desc = 'Auto Farm Near Mob An Island', Default = _G.AutoNear}, function(value)
        _G.AutoNear = (value)
    end)
    ...
    spawn(function()
      ...
      local Section3 = Page1.CreateSection("Quest Farming")
    ...
    if Third_Sea then
        Section3.CreateToggle({Title = 'Farm Bone', Desc = 'Go to castle haunted kill mob to get bone', Default = _G.AutoBone}, function(value)
            _G.AutoBone = (value)
        end)
    ...
    spawn(function()
        ...
        Section3.CreateToggle({Title = "Auto Cake Prince & Dough King", Desc = 'Auto Killing 500 Mobs To Spawn Cake Price else if Have Cake Price or Dough King In Servers then Teleport To Boss and kill And Please Turn Off Bypass Tp For Farm Cake Prince', Default = _G.CakePrince}, function(value)
            _G.CakePrince = (value)
        end)
        ...
        Section3.CreateToggle({Title = "Auto Spawn Cake Prince", Default = false}, function(value)
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")
        end)

        local Section4 = Page1.CreateSection("Mastery Farm")

        Section4.CreateToggle({Title = "Auto Mastery Fruit", Default = _G.AutoFarmFruitMastery }, function(value)
            _G.AutoFarmFruitMastery = (value)
        end)

        Section4.CreateSlider({Title = "Health (%) Mob", Min = 0, Max = 100, Default = 25 }, function(value)
            _G.Kill_At = (value)
        end)
		...
		spawn(function()
            game:GetService("RunService").RenderStepped:Connect(function()
                pcall(function()
                    if UseSkill or _G.SeaSkill then
		...
		spawn(function()
            ...
            local Section5 = Page1.CreateSection("Boss Farm")
            ...
            Section5.CreateDropdown({Title = "List Boos", List = tableBoss, Search = false, Selected = false}, function(value)
                _G.SelectBoss = (Value)
            end)

            Section5.CreateToggle({Title = "Auto Kill Boss", Default = _G.AutoBoss }, function(value)
                _G.AutoBoss = (value)
            end)
...
if First_Sea then
            Section6.CreateToggle({Title = "Auto Quest Sea 2", Default = _G.AutoSecondSea }, function(value)
...
if Second_Sea then
        Section6.CreateToggle({Title = "Auto Quest Sea 3", Default = _G.AutoThirdSea }, function(value)
    ...
    local Section7 = Page2.CreateSection("Sword Quest")

    Section7.CreateToggle({Title = "Auto Get Saber Sword", Default = _G.Auto_Saber }, function(value)
        _G.Auto_Saber = (value)
    end)
    spawn(function()
        while task.wait() do
    ...
    Section7.CreateToggle({Title = "Auto Hallow Scythe", Default = AutoHallowSycthe }, function(value)
    ...
    Section7.CreateToggle({Title = "Auto Get Yama Sword", Default = _G.AutoYama }, function(value)
        _G.AutoYama = (value)
    end)
    ...
    Section7.CreateToggle({Title = "Auto Get Tushita Sword (Kill Boss Longma)", Default = AutoTushita }, function(value)
        AutoTushita = (value)
    end)
    ...
    spawn(function()
        ...
        Section7.CreateToggle({Title = "Auto Holy Torch", Default =  _G.Auto_Holy_Torch }, function(value)
        ...
        Section7.CreateToggle({Title = "Auto Buddy Sword", Default =  _G.AutoBudySword }, function(value)
            _G.AutoBudySword = (value)
        end)

        Section7.CreateToggle({Title = "Auto Cavander", Default = _G.AutoCarvender }, function(value)
            _G.AutoCarvender = (value)
        end)

        Section7.CreateToggle({Title = "Auto Twin Hook", Default = _G.AutoTwinHook }, function(value)
            _G.AutoTwinHook = (value)
        end)

        Section7.CreateToggle({Title = "Auto CDK (Beta) ", Default = Auto_Cursed_Dual_Katana }, function(value)
        ...
        local Section8 = Page2.CreateSection("Sword Quest + Hop")

        Section8.CreateToggle({Title = "Auto Hallow Scythe + Hop", Default = false }, function(value)
            _G.Hop = (value)
        end)

        Section8.CreateToggle({Title = "Auto Get Yama Sword + Hop ", Default = false }, function(value)
            _G.Hop = (value)
        end)

        Section8.CreateToggle({Title = "Find Boss Longma + Hop", Default = false }, function(value)
            _G.Hop = (value)
        end)
        ...
        Section8.CreateToggle({Title = "Auto Cavander + Hop", Default = false }, function(value)
            _G.Hop = (value)
        end)

        Section8.CreateToggle({Title = "Auto Twin Hook + Hop", Default = false }, function(value)
            _G.Hop = (value)
        end)
        ...
        local Section9 = Page2.CreateSection("Quest Mob")

            Section9.CreateToggle({Title = "Auto Farm Factory", Default = false }, function(value)
                _G.Factory = (value)
            end)
            ...
            Section9.CreateToggle({Title = "Auto Pirate Raid / indra", Default = false }, function(value)
                _G.CastleRaid = (value)
            end)
            ...
            spawn(function()
                ...
                Section9.CreateToggle({Title = "Auto Elite Hunter", Desc = 'GetQuest Elite and Find To Kill In Third Sea.', Default = false }, function(value)
                    _G.AutoElite = (value)
                end)
                ...
                Section9.CreateToggle({Title = "Auto Get Ghoul Race", Desc = 'If Your Not Have Ghoul Race, function when check boss cursed captan in Cursed Ship to kill, if have torch will teleport to npc and get ghoul race', Default = false }, function(value)
  ...
  local Section10 = Page3.CreateSection("Status Account")
...
local Section11 = Page3.CreateSection("Status Server")

local MirageStatus = Section11.CreateLabel({Title = "Mirage Island: "})
task.spawn(function()
    while task.wait() do
        pcall(function()
...
task.spawn(function()
    ...
    local LeviStatus = Section11.CreateLabel({Title = "Frozen Dimension: "})
    spawn(function()
        pcall(function()
            while wait() do
...
local Section12 = Page2.CreateSection("Gun item")

Section12.CreateToggle({Title = "Auto Get Soul Gitar", Default = false }, function(value)
...
local Section13 = Page3.CreateSection("Server")

Section13.CreateButton({Title = "How server low player"}, function()
    _G.AutoRejoin = false
...
Section13.CreateToggle({Title = "Auto Rejoin Server if u got kick"}, function(value)
    _G.AutoRejoin = (value)
end)
...
local Section14 = Page12.CreateSection("Setting Config Farm")
...
spawn(function()
    while wait() do
        ...
        Section14.CreateToggle({Title = "Bypass Teleport", Default = false }, function(value)
            BypassTP = (value)
        end)

        Section14.CreateToggle({Title = "Remove Noitfy", Default = false }, function(value)
            RemoveNotify = (value)
        end)
        spawn(function()
            while wait() do
        ...
        local Section15 = Page12.CreateSection("Setting Coordinates Farm")
        ...
        local Section16 = Page4.CreateSection(" Player ")
        ...
        Playerslist = {}
            ...
            Section16.CreateDropdown({Title = "List Players", List = Playerslist, Search = false, Selected = false}, function(value)
                _G.SelectPly = (Value)
            end)

            Section16.CreateButton({Title = "Refresh List Players"}, function()
                NewPlayerList = {}
    ...
    SelectedPly:Refresh(NewPlayerList)
            ...
            Section16.CreateToggle({Title = "Tween To Players", Default = false }, function(value)
        ...
        local Section17 = Page4.CreateSection(" Aim ")

        Section17.CreateToggle({Title = "AimBot (use with select player)", Default = false }, function(value)
            _G.Aimbot_Gun = (Value)
        _G.Aimbot_Skill = (Value)
        end)

        Section17.CreateToggle({Title = "AimBot Skill Nearest", Default = false }, function(value)
        ...
        local Section18 = Page5.CreateSection(" Devil Fruit ")
        ...
        Section18.CreateToggle({Title = "Auto Store Fruit", Default = false }, function(value)
            _G.AutoStore = (value)
        end)
...
Section18.CreateToggle({Title = "Tween To Devil Fruit If Spawn", Default = false }, function(value)
...
Section18.CreateDropdown({Title = "Select Fruit Snipe", List = FruitList, Search = false, Selected = false}, function(Value)
    _G.SelectSnipe = Value
end)

Section18.CreateToggle({Title = "Auto Buy Snipe Fruit", Default = false}, function(Value)
...
Section19.CreateToggle({Title = "Esp Player", Default = false}, function(Value)
    ESPPlayer = (value)
	UpdatePlayerChams()
end)

Section19.CreateToggle({Title = "Esp Devil Fruit", Default = false}, function(Value)
    DevilFruitESP = (Value)
...
Section19.CreateToggle({Title = "Esp Island", Default = false}, function(Value)
    IslandESP = (Value)
...
Section20.CreateButton({Title = 'Teleport To Raid Room'}, function()
    Raidroom()
end)
function Raidroom()
...
Section20.CreateDropdown({Title = "Select Chip", List = listchip, Search = false, Selected = false}, function(Value)
    SelectChip = (Value)
end)

Section20.CreateToggle({Title = "Auto Buy Chip Select", Default = false}, function(Value)
...
Section20.CreateToggle({Title = "Auto Start Chip", Default = false}, function(Value)
...
Section20.CreateToggle({Title = "Kill Mob Aura", Default = false}, function(Value)
    KillAura = (Value)
end)
spawn(function()
    while wait() do
...
Section20.CreateToggle({Title = "Auto Next Island", Default = false}, function(Value)
    _G.NextIsland = (Value)
end)
spawn(function()
    pcall(function()
...
Section20.CreateToggle({Title = 'Auto Wakening', Default = false}, function(Value)
    _G.Wakening = (Value)
end)
...
local Section21 = Page6.CreateSection(" Order Raid ")

Section21.CreateToggle({Title = 'Auto Buy Chip Order Raid', Default = false}, function(Value)
    _G.Auto_Buy_Law_Chip = (Value)
end)

Section21.CreateToggle({Title = 'Auto Start Order Raid And Kill', Default = false}, function(Value)
...
Section21.CreateToggle({Title = 'Auto Kill Order Raid', Default = false}, function(Value)
...
Section22.CreateDropdown({Title = "Select Stas To Add", List = {"Melee", "Defense", "Sword", "Gun", "Devil Fruit"}, Search = false, Selected = false}, function(Value)
    _G.Stats = (Value)
end)
spawn(function()
    while wait() do
...
Section22.CreateToggle({Title = "Auto Stats Kaian", Default = false}, function(Value)
...
local Section23 = Page7.CreateSection(" Player ")

Section23.CreateToggle({Title = "Dash No Cooldown", Default = false}, function(Value)
    _G.DashNoCd = (Value)
end)
...
Section23.CreateToggle({Title = "Walk On Water", Default = false}, function(Value)
    _G.WalkWater = (Value)
end)
spawn(function()
    while task.wait() do
...
if First_Sea then
    ...
    Section24.CreateDropdown({Title = "Select Stas To Add", List = MaterialList, Search = false, Selected = false}, function(Value)
        SelectMaterial = (Value)
    end)
    
    Section24.CreateToggle({Title = "Auto Farm Material", Default = false}, function(Value)
    ...
    spawn(function()
      ...
      local Section25 = Page8.CreateSection("Travel Sea")

      Section25.CreateButton({Title = "Travel To Sea 1"}, function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)

    Section25.CreateButton({Title = "Travel To Sea 2"}, function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)

    Section25.CreateButton({Title = "Travel To Sea 3"}, function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)

    local Section26 = Page8.CreateSection("Travel")
    ...
    if First_Sea then
       ...
       elseif Third_Sea then
           ...
           Section26.CreateDropdown({Title = "Select Island", List = IslandList, Search = false, Selected = false}, function(Value)
            _G.SelectIsland = Value
        end)

Section26.CreateToggle({Title = "Travel Island", Default = false}, function(Value)
    ...
    local Section27 = Page9.CreateSection("Sword")

    Section27.CreateToggle({Title = "Auto Buy All Sword Can Buy", Default = false}, function(Value)
    ...
    Section29.CreateToggle({Title = "Auto Buy All Gun Can Buy", Default = false}, function(Value)
        _G.BuyAllGun = (Value)
    end)
        ...
        while wait() do
            if _G.BuyAllGun then
                pcall(function()
                    ...
                    local Section30 = Page9.CreateSection("Fighting Style")
                    ...
                    local Section31 = Page9.CreateSection("Accessories")

                    Section31.CreateToggle({Title = "Auto Buy All Accessories", Default = false}, function(Value)
                        _G.BuyAllAcc = (Value)
                    end)
                    spawn(function()
                        while wait() do
                    ...
                    local Section32 = Page10.CreateSection("Teleport")

                    Section32.CreateButton({Title = "Teleport To Top On Great Tree"}, function()
                        TweenTopOnGreatTree()
                    end)
...
Section32.CreateButton({Title = "Teleport to Temple of Time"}, function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
end)

Section32.CreateButton({Title = "Teleport To Lever Pull"}, function()
...
Section32.CreateButton({Title = "Teleport To Race Doors"}, function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
        wait(0.1)
           Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
           wait(0.1)
...
Section32.CreateToggle({Title = "Auto Teleport To Mirage Island", Default = false}, function(Value)
...
Section32.CreateToggle({Title = "Auto Find Mirages Island", Default = false}, function(Value)
    _G.dao = (Value)
end)
if state then
    _G.dao = true
...
Section32.CreateToggle({Title = "Teleport To Advanced Fruit Dealer", Default = false}, function(Value)
    _G.Miragenpc = (Value)
end)
spawn(function()
    pcall(function()
...
Section32.CreateToggle({Title = "Lock Cam To Moon", Default = false}, function(Value)
    _G.AutoDooHee = (Value)
end)
spawn(function()
    while wait() do
...
Section32.CreateToggle({Title = "Teleport To Blue Gear", Default = false}, function(Value)
    _G.TweenMGear = (Value)
end)
spawn(function()
    pcall(function()
...
Section32.CreateToggle({Title = "Auto Turn On Race V3", Default = false}, function(Value)
    _G.AutoT = (Value)
end)
spawn(function()
    while wait() do
    ...
    Section32.CreateToggle({Title = "Auto Turn On Race V4", Default = false}, function(Value)
        _G.AutoY = (Value)
    end)
    spawn(function()
        while wait() do
...
local Section33 = Page10.CreateSection("Upgrade Race")

Section33.CreateToggle({Title = "Auto Evo Race (V1 -> V2)", Default = false}, function(Value)
...
Section33.CreateToggle({Title = "Auto Complete Trial", Default = false}, function(Value)
...
Section33.CreateToggle({Title = "Kill Player After Complete Trial Use Melee", Desc = 'Recommend Use Electric Claw or Dragon Talon', Default = false}, function(Value)
...
spawn(function()
    ...
    until _G.KillAfterTrials == false or v.Humanoid.Health == 0 or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid") or not v.Parent or NextplySelect == true
    NextplySelect = false
...
Section33.CreateToggle({Title = "Kill Player After Complete Trial No Spam Skill Melee", Desc = 'Recommend Use Electric Claw or Dragon Talon', Default = false}, function(Value)
    _G.taixiucommunity = (Value)
end)
spawn(function()
    while wait() do 
        pcall(function()
            if _G.taixiucommunity then
                for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if v.Name ~= game.Players.LocalPlayer.Name and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
                        if v.Humanoid.Health > 0 then
                            repeat wait(_G.Fast_Delay)
                                ...
                                v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                Click()
                            until not _G.taixiucommunity or not v.Parent or v.Humanoid.Health <= 0 
                        end
                    end
                end
            end
    ...
    Section33.CreateToggle({Title = "Auto Upgrade Race Trial", Default = false}, function(Value)
...
local Section34 = Page11.CreateSection("Rough Sea")

local LeviStatus = Section34.CreateLabel({Title = "Waiting For Fix and Upgrade Sea Event"})

        local Section35 = Page11.CreateSection("Zone Frozen Dimension")

        Section35.CreateToggle({Title = "Auto Tween Frozen Dimension", Default = false}, function(Value)
        ...
        local Section36 = Page11.CreateSection("Event Kitsune Island")
        
        Section36.CreateToggle({Title = "Auto Tween To kitsune island If Spawn", Default = false}, function(Value)
            _G.tpkit = (Value)
        end)
        ...
        Section36.CreateToggle({Title = "Auto Collect Azure Embers", Default = false}, function(Value)
        ...
        Section36.CreateSlider({Title = "Set Azure Ember", Min = 10, Max = 25, Default = 15 }, function(value)
            _G.SetToTradeAureEmber = (value)
        end)

        Section36.CreateToggle({Title = "Auto Trade Azure Ember [Enable with Set Azure Ember]", Default = false}, function(Value)
        ...
        Section37.CreateButton({Title = "Join Marines Team"}, function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
        end)

        Section37.CreateButton({Title = "Fruit Stock Normal"}, function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
            game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
        end)

        Section37.CreateButton({Title = "Open Ui Awk Skill"}, function()
            game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true
        end)

        Section37.CreateButton({Title = "Color Haki Menu"}, function()
            game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
        end)

        Section37.CreateButton({Title = "Title Name Menu"}, function()
            local args = {
                [1] = "getTitles"
            }
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
        ...
        Section37.CreateButton({Title = "Remove Fog"}, function()
